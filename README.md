...
3. Run the above google colab script and upload the mp3 there. Run the scrpt to generate the srt file.
4. Upload the srt file along with the audio into a new page (it can be copy of any other page)
5. Change the paragraph array (So that the frontend knows where to seperate out the paragraphs)
6. Make a few changes in the index.html page so people can navigate to it.
